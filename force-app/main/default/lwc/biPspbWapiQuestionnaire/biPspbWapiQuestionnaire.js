...
export default class BiPspbWapiQuestionnaire extends LightningElement {
	...
	*/
    ...
    numberFields.forEach(field => {
		...
		if (this.totalValueToUi !== 168 && this.isFalse === true && isAnyFieldEmpty=== false) {
	...
	*/
	...
	prepareResponseArrays() {
		...
		if (this.secondNumberValue !== '' && this.secNumisTrue===false) {
			...
			console.log('8.2',this.thirdDraftResp);
			console.log('8.3',this.thirdDraftVersionId);
		}
		if (this.thirdNumberValue !== '' && this.thirdNumisTrue===false) {
			...
			console.log('9',this.fourthRspValue);
			console.log('9.1',this.fourthVersionId);
			...
			console.log('9.2',this.fourthDraftRes);
			console.log('9.3',this.fourthDraftVersionId);
		}
	...
	submitResponses(draft, twoMonths) {
		...
		console.log('5',nonEmptyResponses.length);
		let nonEmptyIds = this.realAssesVerArra.filter(id => id !== '');
		console.log('6',nonEmptyIds.length);
